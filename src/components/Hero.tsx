  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 z-0 opacity-40">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-ohwow-gold/10 blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/3 right-1/3 w-96 h-96 rounded-full bg-ohwow-gold/5 blur-3xl animate-pulse delay-700"></div>
      </div>
      ...
      <div className="container mx-auto px-4 z-10 pt-16">
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-4 flex justify-center">
            <span className="px-3 py-1 rounded-full border border-ohwow-gold/30 bg-ohwow-gold/10 text-ohwow-gold text-sm">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="oh-wow-button-primary flex items-center justify-center">
              Get a Free Consultation
              <ArrowRight className="ml-2 h-5 w-5" />
            </button>
            <button className="oh-wow-button-secondary flex items-center justify-center">
              See Our Work
            </button>
          </div>
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-8 opacity-70">
            <div className="text-center text-ohwow-white/80">
              <p className="text-3xl font-bold text-ohwow-gold mb-1">230%</p>
              <p className="text-sm uppercase">Avg. ROI Increase</p>
            </div>
            <div className="text-center text-ohwow-white/80">
              <p className="text-3xl font-bold text-ohwow-gold mb-1">40+</p>
              <p className="text-sm uppercase">Real Estate Projects</p>
            </div>
            <div className="text-center text-ohwow-white/80">
              <p className="text-3xl font-bold text-ohwow-gold mb-1">24/7</p>
              <p className="text-sm uppercase">Lead Generation</p>
            </div>
            <div className="text-center text-ohwow-white/80">
              <p className="text-3xl font-bold text-ohwow-gold mb-1">15K+</p>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
        ...
        <div className="w-6 h-10 rounded-full border-2 border-ohwow-white/20 flex justify-center">
          <div className="w-1.5 h-3 bg-ohwow-gold rounded-full mt-2 animate-bounce"></div>
        </div>
      </div>
    </section>
  );
